        ...
        <div className="max-w-7xl mx-auto px-4 py-6 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/club-members">
              <Button
                variant="default"
                className="bg-blue-600 hover:bg-blue-700 rounded-xl shadow-lg shadow-blue-500/20"
              >
                View Club Members
              </Button>
            </Link>
                    ...
                    {members.map((member, idx) => {
                      ...
                      return (
                        <motion.div
                          ...
                          whileHover={{ y: -10 }}
                          className="group relative flex flex-col items-center justify-center w-full md:w-[calc(50%-1.25rem)] lg:w-[calc(33.333%-2.333rem)] max-w-[320px]"
                        >
